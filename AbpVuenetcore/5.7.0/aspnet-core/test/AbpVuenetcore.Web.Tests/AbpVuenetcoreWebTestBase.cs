...
{
    public abstract class AbpVuenetcoreWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AbpVuenetcoreWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AbpVuenetcoreWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AbpVuenetcoreDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AbpVuenetcoreDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AbpVuenetcoreDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AbpVuenetcoreDbContext, Task<T>> func)
        {
            T result;
