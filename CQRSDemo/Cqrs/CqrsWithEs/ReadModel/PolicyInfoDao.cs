...
namespace CqrsWithEs.ReadModel
{
    public class PolicyInfoDao
    {
        ...
        public void CreatePolicyInfo(Guid id, string policyNumber, DateTime coverFrom, DateTime coverTo, string policyHolderFirstName, string policyHolderLastName, string carPlateNumber, string carMake, decimal totalPremium)
        {
            ...
            cn.Open();
            cn.Execute("INSERT INTO public.policy_info_view (policy_id,policy_number,cover_from,cover_to,vehicle,policy_holder,total_premium) " +
                    "VALUES (@PolicyId,@PolicyNumber,@CoverFrom,@CoverTo,@Vehicle,@PolicyHolder,@TotalPremiumAmount)",
                    policyInfo);

        }
        public void UpdatePolicyInfo(Guid id,
                string policyNumber,
                DateTime coverFrom,
                DateTime coverTo,
