...
{
    public class PolicyInfoSynchronizer : INotificationHandler<InitialPolicyVersionCreated>,
        ...
        INotificationHandler<TerminalPolicyVersionConfirmed>
    {
        ...
        public Task Handle(CoverageExtendedPolicyVersionConfirmed notification, CancellationToken cancellationToken)
        {
