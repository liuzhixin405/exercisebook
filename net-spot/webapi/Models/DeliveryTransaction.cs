...
namespace webapi
{
    ...
    public partial class DeliveryTransaction
    {
        ...
        /// <summary>
        /// 交割类型(日交割:&apos;d&apos;,当周交割:&apos;w&apos;,次周交割:&apos;nw&apos;,当月交割:&apos;m&apos;,次月交割:&apos;nm&apos;,季度交割:&apos;q&apos;,次季度交割:&apos;nq&apos;,半年交割:&apos;hy&apos;,年交割:&apos;y&apos;,)
        /// </summary>
        ...
        /// 合约显示名称
        /// </summary>
        public string TransactionShowName { get; set; } = null!;
        public string TransactionShowNameEn { get; set; } = null!;
        public string TransactionShowNameJp { get; set; } = null!;
        public string TransactionShowNameKr { get; set; } = null!;
        public string TransactionShowNameHk { get; set; } = null!;
    }
}
