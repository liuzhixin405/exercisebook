...
(function(factory) {
     ...
     ********************/
        ...
        _generateMarkup: function() {
            ...
            this.selectedFlagInner = $("<div>", {"class": "flag"}).appendTo(selectedFlag);
            ...
            this.countryList = $("<ul>", {"class": "country-list"}).appendTo(this.countryListDiv);
            if (this.preferredCountries.length) {
                this._appendListItems(this.preferredCountries, "preferred");
                $("<li>", {"class": "divider"}).appendTo(this.countryList);
            }
            $("<input>", {"class": "search-input", "type": "text", "id": "searchInput", "placeholder": "搜索"}).insertBefore(".country-list");
            ...
            if (filter && filter.length > 0) {
                for (var i = 0;  i < all.length; i++) {
                    ...
                    if (showname && (showname.toUpperCase().startsWith(filter.toUpperCase()) || showname.toUpperCase().indexOf(filter.toUpperCase()) > 0)
                        || dialCode && dialCode.startsWith(filter) || dialCode.indexOf(filter) > 0) {
        ...
        _bindDropdownListeners: function() {
            ...
            this.countryListDiv.on("click" + this.ns, ".search-input", function() {
                isOpening = true;
            });
            this.countryListDiv.on('keyup' + this.ns, ".search-input", function() {
        ...
        _closeDropdown: function() {
            ...
            $("#searchInput").val("");//关闭下拉框后，搜索框内的值这位空
            this.countryList.html("");
