...
AmCharts.addInitHandler(function(t) {
    function e(r, o, n, u) {
        ...
        c.remaining++,
        c.percentLoaded[r] = 0,
        void 0 !== n.progress && "function" == typeof n.progress && void 0 === n._progress && (n._progress = n.progress, n.progress = function(t) {
            c.percentLoaded[r] = t;
            var e = 0,
            a = 0;
        ...
        AmCharts.loadFile(r, n,
        function(s) {
            if (!1 === s) l(n.error, n, t),
            i(AmCharts.__("Error loading the file", t.language) + ": " + r, !1, n);
            else {
                switch (void 0 === n.format && (n.format = "json"), n.format = n.format.toLowerCase(), n.format) {
                case "json":
                    if (o[u] = AmCharts.parseJSON(s), !1 === o[u]) return l(n.error, n, t),
                    ...
                    break;
                case "csv":
                    if (o[u] = AmCharts.parseCSV(s, n), !1 === o[u]) return l(n.error, n, t),
                    ...
                    break;
                default:
                    return l(n.error, n, t),
                    void i(AmCharts.__("Unsupported data format", t.language) + ": " + n.format, !1, n.noStyles)
                }
                if (c.remaining--, 0 === c.remaining && (l(n.complete, t), n.async)) if ("map" === t.type) t.validateNow(!0),
                d();
                else if ("gauge" !== t.type && t.addListener("dataUpdated",
                function(e) {
                    "stock" !== t.type || n.reloading || void 0 === t.periodSelector || t.periodSelector.setDefaultPeriod(),
                    d(),
                    ...
                    for (var p = 0; p < t.panels.length; p++) t.panels[p].startDuration = c.startDuration,
                    t.panels[p].animateAgain()
                } else t.startDuration = c.startDuration,
    ...
    function a(e, a) {
        ...
        try {
            ...
            return i(AmCharts.__("Error loading file", t.language) + ": " + a.url, !1, a),
            e
        }
    }
    function r(t) {
    ...
    function s(e, a) {
        d(),
        void 0 === e && (e = AmCharts.__("Loading data...", t.language));
        ...
        c.loadData = function() {
            if ("stock" === t.type) setTimeout(function() {
                ...
                for (var a = 0; a < t.dataSets.length; a++) {
                    var r = t.dataSets[a];
                    void 0 !== r.dataLoader && void 0 !== r.dataLoader.url && (l(r.dataLoader.init, r.dataLoader, t), r.dataProvider = [], o(r.dataLoader), e(r.dataLoader.url, r, r.dataLoader, "dataProvider")),
                    void 0 !== r.eventDataLoader && void 0 !== r.eventDataLoader.url && (l(r.eventDataLoader.init, r.eventDataLoader, t), r.events = [], o(r.eventDataLoader), e(r.eventDataLoader.url, r, r.eventDataLoader, "stockEvents"))
                }
            },
            100);
            else {
                if (l(c.init, c, t), o(c), void 0 === c.url) return;
                void 0 !== t.startDuration && 0 < t.startDuration && (c.startDuration = t.startDuration, t.startDuration = 0),
                "gauge" === t.type ? (void 0 === t.arrows && (t.arrows = []), e(c.url, t, c, "arrows")) : (void 0 === t.dataProvider && (t.dataProvider = "map" === t.type ? {}: []), e(c.url, t, c, "dataProvider"))
            }
        },
        c.loadData()
    }
...
void 0 === AmCharts.__ && (AmCharts.__ = function(t, e) {
...
AmCharts.loadFile = function(t, e, a) {
    ...
    */
	...
	if (!depthData) {
		var response = "{\"asks\":[],\"bids\":[]}";
		depthData = (0 !== JSON ? JSON.parse(response) : eval(response))
	}
	
	a.call(this, depthData);
	
},
AmCharts.parseJSON = function(response) {
    try {
        return response; // void 0 !== JSON ? JSON.parse(response) : eval(response)
    } catch(t) {
        return ! 1
    }
},
AmCharts.parseCSV = function(t, e) {
    ...
    if (e.useColumnNames) {
        s = o.shift();
        for (var d = 0; d < s.length; d++)"" === (a = s[d].replace(/^\s+|\s+$/gm, "")) && (a = "col" + d),
        s[d] = a;
        0 < e.skip && e.skip--
    }
    ...
    for (var l; l = e.reverse ? o.pop() : o.shift();) if (!e.skipEmpty || 1 !== l.length || "" !== l[0]) {
        var u = {};
        for (r = 0; r < l.length; r++) u[a = void 0 === s[r] ? "col" + r: s[r]] = "" === l[r] ? e.emptyAs: l[r],
...
AmCharts.timestampUrl = function(t) {
    var e = t.split("?");
    return 1 === e.length ? e[1] = (new Date).getTime() : e[1] += "&" + (new Date).getTime(),
    e.join("?")
};