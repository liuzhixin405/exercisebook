...
CKEDITOR.dialog.add("form",
    function (a) {
        ...
        return {
            title: a.lang.forms.form.title, minWidth: 350, minHeight: 200,
            ...
            onOk: function () { var b, a = this.form, c = !a; c && (b = this.getParentEditor(), a = b.document.createElement("form"), a.appendBogus()); c && b.insertElement(a); this.commitContent(a) },
            onLoad: function () {
                function a(b) {
