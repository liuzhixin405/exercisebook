...
CKEDITOR.editorConfig = function( config ) {
    ...
    //config.contentsCss = '/editor/ckeditor/contents.css';
    ...
    config.font_names = '黑体/黑体;宋体/宋体;楷体/楷体;幼圆/幼圆;微软雅黑/微软雅黑;' + config.font_names;
    config.font_defaultLabel = '微软雅黑';
    config.fontSize_defaultLabel = '16px';
    config.allowedContent = true;
    config.extraPlugins = 'html5video,lineheight,widget,widgetselection,clipboard,lineutils,wordupload';
    ...
    config.toolbar_Common = [
        ...
        { name: 'insert', items: ['wordupload','Image', 'Flash', 'html5video', 'Table', 'HorizontalRule', 'Smiley', 'SpecialChar', 'Iframe',] },
        '/',
