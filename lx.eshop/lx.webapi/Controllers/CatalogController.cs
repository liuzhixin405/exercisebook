using lx.eshop.models.Catalog;
using lx.eshop.models.Catalog.Extensions;
using lx.eshop.models.Catalog.Infrastructure;
using lx.eshop.models.Paging;
...
namespace lx.webapi.Controllers
{
    ...
    public class CatalogController : ControllerBase
    {
        ...
        public async Task<IActionResult> ItemsAsync([FromQuery] int pageSize = 10, [FromQuery]int pageIndex=0,string ids=null)
        {
            if (!string.IsNullOrEmpty(ids))
            {
                ...
                if(!items.Any())
                {
                    return BadRequest("ids value invalid.Must be comma-separated lsit of numbers");
                }
                return Ok(items);
            }
        ...
        public async Task<ActionResult<CatalogItem>> ItemByIdAsync(int id)
        {
            ...
            item.FillProductUrl(_configuration["base_catalog_uri"]);
        ...
        {
            var baseUri = _configuration["base_catalog_uri"];
