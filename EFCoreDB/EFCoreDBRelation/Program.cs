using EFCoreDBRelation.DataLayer;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Infrastructure;
using Microsoft.EntityFrameworkCore.Storage;

namespace EFCoreDBRelation
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<BlogContext_01>(options => options.UseSqlServer("Data Source=PC-202205262203;Initial Catalog=Blog_02;Persist Security Info=False;User ID=sa;Password=1230;MultipleActiveResultSets=true"));
