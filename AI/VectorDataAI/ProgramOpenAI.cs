...
//        string model = config["ModelName"] ?? "text-embedding-ada-002"; // Default model name
//        string key = config["OpenAIKey"] ?? "YOUR_OPENAI_API_KEY"; // Replace with your OpenAI API key
