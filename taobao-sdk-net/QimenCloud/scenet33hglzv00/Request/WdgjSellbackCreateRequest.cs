...
{
    /// <summary>
    /// TOP API: wdgj.sellback.create
    /// </summary>
    public class WdgjSellbackCreateRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjSellbackCreateResponse>
    {
        /// <summary>
        /// 根据format传入不同类型
        /// </summary>
