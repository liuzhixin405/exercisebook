...
{
    /// <summary>
    /// TOP API: wdgj.customer.grade.get
    /// </summary>
    public class WdgjCustomerGradeGetRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjCustomerGradeGetResponse>
    {
        /// <summary>
        /// 页码
        /// </summary>
        ...
        {
            return "wdgj.customer.grade.get";
        }
