...
{
    /// <summary>
    /// TOP API: wdgj.prover.create
    /// </summary>
    public class WdgjProverCreateRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjProverCreateResponse>
    {
        /// <summary>
        /// 根据format传入不同类型
        /// </summary>
