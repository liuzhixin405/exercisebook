...
{
    /// <summary>
    /// TOP API: wdgj.purchase.create
    /// </summary>
    public class WdgjPurchaseCreateRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjPurchaseCreateResponse>
    {
        /// <summary>
        /// 根据format传入不同类型
        /// </summary>
