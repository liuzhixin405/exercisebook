...
{
    /// <summary>
    /// TOP API: wdgj.stockout.create
    /// </summary>
    public class WdgjStockoutCreateRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjStockoutCreateResponse>
    {
        /// <summary>
        /// 根据format传入不同类型
        /// </summary>
