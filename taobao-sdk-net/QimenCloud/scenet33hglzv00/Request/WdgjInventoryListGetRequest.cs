...
{
    /// <summary>
    /// TOP API: wdgj.inventory.list.get
    /// </summary>
    public class WdgjInventoryListGetRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjInventoryListGetResponse>
    {
        /// <summary>
        ...
        {
            return "wdgj.inventory.list.get";
        }
