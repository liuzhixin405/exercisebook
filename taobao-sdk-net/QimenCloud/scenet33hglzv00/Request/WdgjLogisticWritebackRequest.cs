...
{
    /// <summary>
    /// TOP API: wdgj.logistic.writeback
    /// </summary>
    public class WdgjLogisticWritebackRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjLogisticWritebackResponse>
    {
        /// <summary>
        /// 根据format传入不同类型
        /// </summary>
        ...
        {
            return "wdgj.logistic.writeback";
        }
