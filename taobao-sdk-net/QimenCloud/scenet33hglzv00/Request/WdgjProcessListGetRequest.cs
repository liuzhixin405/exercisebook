...
{
    /// <summary>
    /// TOP API: wdgj.process.list.get
    /// </summary>
    public class WdgjProcessListGetRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjProcessListGetResponse>
    {
        /// <summary>
