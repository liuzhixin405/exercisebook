...
{
    /// <summary>
    /// TOP API: wdgj.stockin.confirm
    /// </summary>
    public class WdgjStockinConfirmRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjStockinConfirmResponse>
    {
        /// <summary>
        /// 根据format传入不同类型
        /// </summary>
        ...
        /// 当前时间的Unix时间戳
        /// </summary>
        public string Wdgjtimestap { get; set; }
        ...
        public override IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("wdgjtimestap", this.Wdgjtimestap);
        ...
        public override void Validate()
        {
            ...
            RequestValidator.ValidateRequired("wdgjtimestap", this.Wdgjtimestap);
