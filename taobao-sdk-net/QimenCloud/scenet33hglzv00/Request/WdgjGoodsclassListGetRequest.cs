...
{
    /// <summary>
    /// TOP API: wdgj.goodsclass.list.get
    /// </summary>
    public class WdgjGoodsclassListGetRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjGoodsclassListGetResponse>
    {
        /// <summary>
        /// 页码
        /// </summary>
        ...
        {
            return "wdgj.goodsclass.list.get";
        }
