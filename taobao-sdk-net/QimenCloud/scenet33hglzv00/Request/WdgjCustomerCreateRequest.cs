...
{
    /// <summary>
    /// TOP API: wdgj.customer.create
    /// </summary>
    public class WdgjCustomerCreateRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjCustomerCreateResponse>
    {
        /// <summary>
        /// 根据format传入不同类型
        /// </summary>
