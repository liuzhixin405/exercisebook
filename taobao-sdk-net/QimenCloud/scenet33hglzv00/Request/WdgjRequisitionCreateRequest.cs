...
{
    /// <summary>
    /// TOP API: wdgj.requisition.create
    /// </summary>
    public class WdgjRequisitionCreateRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjRequisitionCreateResponse>
    {
        /// <summary>
        /// 根据format传入不同类型
        /// </summary>
        ...
        {
            return "wdgj.requisition.create";
        }
