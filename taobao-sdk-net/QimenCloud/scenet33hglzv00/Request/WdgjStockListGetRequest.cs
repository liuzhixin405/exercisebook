...
{
    /// <summary>
    /// TOP API: wdgj.stock.list.get
    /// </summary>
    public class WdgjStockListGetRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjStockListGetResponse>
    {
        /// <summary>
        /// 页码
        /// </summary>
        ...
        public override IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("searchcode", this.Searchcode);
