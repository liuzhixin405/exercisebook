...
{
    /// <summary>
    /// TOP API: wdgj.stock.synchronize
    /// </summary>
    public class WdgjStockSynchronizeRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjStockSynchronizeResponse>
    {
        /// <summary>
        /// 根据format传入不同类型
        /// </summary>
