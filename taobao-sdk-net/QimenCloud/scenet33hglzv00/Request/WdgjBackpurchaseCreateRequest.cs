...
{
    /// <summary>
    /// TOP API: wdgj.backpurchase.create
    /// </summary>
    public class WdgjBackpurchaseCreateRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjBackpurchaseCreateResponse>
    {
        /// <summary>
        /// 根据format传入不同类型
        /// </summary>
        ...
        {
            return "wdgj.backpurchase.create";
        }
