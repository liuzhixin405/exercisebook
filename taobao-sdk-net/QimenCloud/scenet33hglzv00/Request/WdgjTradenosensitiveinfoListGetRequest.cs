...
{
    /// <summary>
    /// TOP API: wdgj.tradenosensitiveinfo.list.get
    /// </summary>
    public class WdgjTradenosensitiveinfoListGetRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjTradenosensitiveinfoListGetResponse>
    {
        /// <summary>
        /// 开始时间
        /// </summary>
        ...
        {
            return "wdgj.tradenosensitiveinfo.list.get";
        }
