...
{
    /// <summary>
    /// TOP API: wdgj.trade.create
    /// </summary>
    public class WdgjTradeCreateRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjTradeCreateResponse>
    {
        /// <summary>
        /// 根据format传入不同类型
        /// </summary>
