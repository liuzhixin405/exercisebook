...
{
    /// <summary>
    /// TOP API: wdgj.stockout.confirm
    /// </summary>
    public class WdgjStockoutConfirmRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjStockoutConfirmResponse>
    {
        /// <summary>
        /// 根据format传入不同类型
        /// </summary>
