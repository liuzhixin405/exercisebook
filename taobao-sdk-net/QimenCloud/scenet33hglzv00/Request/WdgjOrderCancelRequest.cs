...
{
    /// <summary>
    /// TOP API: wdgj.order.cancel
    /// </summary>
    public class WdgjOrderCancelRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjOrderCancelResponse>
    {
        /// <summary>
        /// 根据format传入不同类型
        /// </summary>
