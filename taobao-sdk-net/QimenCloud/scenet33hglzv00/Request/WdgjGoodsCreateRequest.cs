...
{
    /// <summary>
    /// TOP API: wdgj.goods.create
    /// </summary>
    public class WdgjGoodsCreateRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjGoodsCreateResponse>
    {
        /// <summary>
        /// 根据format传入不同类型
        /// </summary>
