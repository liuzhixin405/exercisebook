...
{
    /// <summary>
    /// TOP API: wdgj.inventory.create
    /// </summary>
    public class WdgjInventoryCreateRequest : BaseQimenCloudRequest<QimenCloud.Api.scenet33hglzv00.Response.WdgjInventoryCreateResponse>
    {
        /// <summary>
        /// 根据format传入不同类型
        /// </summary>
