...
namespace CacheManager.Redis
{
        ...
        IRedisValueConverter<object>
    {
        ...
        RedisValue IRedisValueConverter<ushort>.ToRedisValue(ushort value) => (ulong)value;

        ushort IRedisValueConverter<ushort>.FromRedisValue(RedisValue value, string valueType) => (ushort)(ulong)value;
