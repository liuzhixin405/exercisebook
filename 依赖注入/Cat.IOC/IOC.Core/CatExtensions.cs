...
namespace IOC.Core
{
    public static class CatExtensions
    {
       ...
       => cat.Register(typeof(TFrom), typeof(TTo), lifetime);
        ...
        public static Cat Register<TService>(this Cat cat, Type serviceType,Func<Cat,object> factory,Lifetime lifetime)
        {          
            cat.Register(new ServiceRegistry(serviceType,lifetime,(_,arguments)=>factory(_)));
            return cat;
        }
        public static Cat Register<TService>(this Cat cat, Type serviceType, Func<Cat, TService> factory, Lifetime lifetime)
        {
