...
namespace RazorPagesPizza.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync([FromServices] QRCodeService qrCodeService) // 【注入QRCodeService
        {
            ...
            QRCodeAsBase64 = qrCodeService.GetQRCodeAsBase64(AuthenticatorUri); // 【调用QRCodeService
            return Page();
        }
