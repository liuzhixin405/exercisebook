...
namespace Project.Domain.SeedWork
{
    public abstract class ValueObject : IEquatable<ValueObject>
    {
        ...
        private IEnumerable<FieldInfo> GetFields()
        {
            ...
            {
                this._fields = GetType().GetFields(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic).Where(x => x.GetCustomAttribute(typeof(IgnoreMemberAttribute)) == null).ToList();
            }
            return this._fields;
        }
