...
namespace Crawler.Selenium.Helper
{
    public class SeleniumHelper
    {
        ...
        private string CheckIsLogin(string message, RemoteWebDriver driver)
        {
            ...
            {
                CommonHelper.ConsoleAndLogger($"*********errorMessage: {ex.Message} ***********", CommonHelper.LoggerType.Error);
                throw;
            }
            return message;
        }
        ...
        bool IsConsoleLog = bool.Parse(ApplicationConfig.Configuration["IsConsolePage"]);
