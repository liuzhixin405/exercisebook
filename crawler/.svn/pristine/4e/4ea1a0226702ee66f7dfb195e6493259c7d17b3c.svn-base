...
namespace CrawlerConsole.TaskManager
{
    ...
    public class DigShortCodeJob : IJob
    {
        ...
        {
            Console.WriteLine("instagram loging ...");
            if (driver == null)
            {
                #region cookie登录
        ...
        private void PageScrolling(RemoteWebDriver driver, string source)
        {
            ...
            while (isGoto)
            {
                ...
                DigShortCode(driver, isFirst, source); //获取shortcode
        ...
        private void DigShortCode(RemoteWebDriver driver, bool isFirst, string source)
        {
            ...
            foreach (var item in webElements.TakeLast(isFirst ? webElements.Count() : 15))
            {
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(href))
                    {
                        ...
                        ResponseMessage response = PushTarpa(shortCode, source);
        ...
        /// <returns></returns>
        private static ResponseMessage PushTarpa(string shortCode, string source)
        {
