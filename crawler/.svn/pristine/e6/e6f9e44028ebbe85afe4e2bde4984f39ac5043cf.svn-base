...
namespace Crawler.Utility.Model
{
    public sealed class Constants
    {
        ...
        public const string SDK_VERSION = "top-sdk-net-20200723";
        public const string SDK_VERSION_CLUSTER = "top-sdk-net-cluster-20200723";
